package term1.lesson20.opgave1;
...
public class SwimmerApp {
    ...
    public static void main(String[] args) {
        ...
        int totalTrainingHoursAll = 0;
        for (Swimmer s : swimmers) {
            System.out.println(s.getName() + "'s bedste tid: " + s.bestLapTime());
            int allTrainingHours = s.allTrainingHours();
            System.out.println(s.getName() + "s træningstid i alt: " + allTrainingHours);
            totalTrainingHoursAll += allTrainingHours;
        }

        System.out.println("Samlet træningstid for alle svømmere: " + totalTrainingHoursAll);
