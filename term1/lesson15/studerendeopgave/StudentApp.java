package term1.lesson15.studerendeopgave;
...
public class StudentApp extends Application {
	...
	private final TextArea txAge = new TextArea();
	...
	private void addAction() {
		if (studerende == null) {
			studerende = new Student(txfName.getText().trim(), Integer.parseInt(txAge.getText()), chkActive.isSelected());
			clearFields();
