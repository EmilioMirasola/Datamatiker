...
public class EmployeeWindow extends Stage {
    ...
    private ComboBox<Integer> cbbEmploymentYear;
    ...
    private void initContent(GridPane pane) {
        ...
        cbbEmploymentYear = new ComboBox<>();

        cbbEmploymentYear.getItems().addAll(getYearOptions());
        pane.add(cbbEmploymentYear, 0, 6);
        cbbEmploymentYear.setDisable(true);
    ...
    private void initControls() {
        if (employee != null) {
            ...
            if (employee.getCompany() != null) {
                ...
                cbbEmploymentYear.getSelectionModel().selectFirst();
            } else {
                cbbEmploymentYear.getSelectionModel().selectFirst();
    ...
    private void selectedCompanyChanged(boolean checked) {
        ...
        cbbEmploymentYear.setDisable(!checked);
    }
